...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2022 a las 11:05:19
...
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `fk_municipios_1` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
